      ...
      <main className="dark:text-neutral-100 flex min-h-screen flex-col items-center justify-center  bg-black">
        ...
        <Image src={grpImg} className="block w-full h-full object-cover" alt="group photo" />
            ...
            <div className="flex-1 bg-slate-900">
              <div className="p-4">
<h3 className="text-neutral-100 text-3xl uppercase">Story</h3>
<div className="my-4">
<p className="my-2">
  In the far-off future in 4269 a special team of animals has joined in the exploration of the universe. They have been trained and outfitted with specially designed spacesuits.
  </p>
  <p className="my-2">
...
<Image src={story4} alt="storyboard part" className="w-full h-full" />
          ...
          <h2 id="products" className="text-neutral-100 text-5xl uppercase my-6 pt-2">Products</h2>
